    ...
    return (
      <>
        <div className="min-h-screen bg-gradient-to-br from-indigo-200 via-purple-200 to-pink-200 flex items-center justify-center p-4">
            <div className="backdrop-blur-md bg-white/30 border border-white/40 shadow-lg max-w-md w-full text-center p-10 relative bg-gradient-to-r from-blue-300 to-pink-200 rounded-xl opacity-80">
